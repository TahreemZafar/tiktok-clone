        ...
        <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4 ">
          ...
          <div className="mt-8 md:flex gap-6 ">
            {!fileDisplay ? (
              ...
              >
                <BiSolidCloudUpload size={45} color="#b3b3b1" />
...
"
              >
                {isUploading ? (
                  <div className="absolute flex items-center justify-center z-20 bg-black h-full w-full rounded-[50px] bg-opacity-35">
                ...
                <div className="absolute -bottom-12 flex items-center border justify-between z-50 rounded-xl w-full p-2 border-gray-300 ">
                  <div className="flex items-center truncate ">
                    <AiOutlineCheckCircle
                      size={19}
                      className="min-w-[16px] fill-green-600 "
                    />

                    <p className="truncate text-[12px] pl-2 text-ellipsis ">
                      {file ? file.name : ""}
                    </p>
                  </div>
            ...
            <div className="mt-4 mb-6 ">
              <div className="flex bg-[#f8f8f8] py-4 px-6 ">
                <div>
                  <PiKnifeLight className=" mr-4 " color="black" size={20} />
                </div>

                <div>
                  <div className="font-semibold text-[15px] mb-1.5 ">
                    Divide videos and edits
                  </div>
                  <div className=" font-semibold text-[13px] text-gray-500/80 ">
                ...
                <div className="flex justify-end max-w-[130px] w-full h-full my-auto text-center ">
